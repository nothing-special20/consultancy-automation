...
def remove_titles(df):
    ...
    crypto = ["nft", "crypto", "blockchain", "opensea", "web3", "web 3", "trading", "trader", "coingecko"]

    microsoft = ["vba", "\\.net", "Microsoft 365", "vba", "visual basic", "dynamics", "microsoft access", "excel", "powerbi", "power bi", "Intune"]

    ignore = ["Casino", "gamble", "marijuana", "dating", "girlfriend", "Cannabis", "THC", "gummies", "dispensary", "LGBT", "gay", "model agency", "Green Energy", "Social Justice", "onlyfans", "only fans", "political", "smoke", "culture", "change your life", "Remote Work"]

    code_tools = ["Playwright", "SAP BW", "SQL dev", "NET dev", "AWS EKS", "architect", "fin tech"]
    ...
    misc_technical = ["website build", "website for", "website design", "framer", "full.stack dev", "Office 365", "sap hana", "oracle", "cisco", "citrix", "docker", "kubernetes", "cloud base", "wweb design", "End Engineer", "webflow", "looker", "GraphQL", "Database Builder", "Chrome Extension", "scrape", "scraping", "azure", "Google Apps", "aws ", "hana", "osint", "Microsoft Dynamics 365", "axiom", "rust", "sap int", "Browser Automation", "Grafana", "snowflake", "tableau", "scripts", "cobol", "Siemens", "TypeScript", "sap security", "Adobe"]

    misc_biz_software = ["asana", "jira"]

    no_code_low_code = ["bubble", "n8n"]

    digital_marketing = ["amazon ppc", "digital marketing for", "conversion track", "seo for", "seo audit", "Digital Marketing Consultant", "Landing Page", "advertising expert", "convertkit", "ui design", "Click {0,1}Funnels", "Keyword Specialist", "SEO Campaign", "wordpress", "Google merchant", "wix", "NetSuite", "LinkedIn Campaign Setup", "Facebook Campaign Setup", "Build a website", "Generate Leads", "MS SQL", "Marketing Advice", "ad optimiz", "marketing plan", "Digital Marketer Needed", "youtube", "LinkedIn Ads", "website redesign", "Digital marketer", "seo ", "Elementor", "Woocommerce", "Media buying", "PPC Campaign", "Amazon Marketing", "reddit", " bing", "link build", "ad words", "PPC Ads expert", "PPC - Google Ads", "Google Local Ads", "PPC", "copy edit", "twitter", "dropship", "Google Shopping", "Google Ad", "macOS", "advertising for", "Google MyBusiness", "Marketing Consultant", "Digital Marketing Specialist"]

    misc_professional = ["payroll", "bookkeep", "mechanical engineer", "talent scout", "regulat", "legal", "data engineer", "civil engineer", "Business Development Executive", "AutoCAD", "Business Analyst", "quality assu", "Google Expert", "sales exec", "High Ticket Closer", "sales closer", " pr ", "non.{0,1}profit", "Sales Expert", "Fractional"]

    random = ["newsletter", "discord", "guru", "google maps", "brand", "Students", "stripe", "research", "translat", "presentation", "bonus", "amazon", "game", "stories", "Exchange", "stock"]
...
def remove_descriptions(df):
    rm_descriptions = ["join our [team|agency]", "cover letter", "c\\+\\+", "IoT", " va ", "mobile app dev", "php", "admin assistant", "resume", "guru", "Responsibilities", "Solidworks", "NO PREVIOUS EXPERIENCE NECESSARY", "cross-{0,1}functional teams", "stock opportunities", "Digital Marketing specialist", "youtube", "virtual machine"] 
...
def build_params_list():
    crm_automation_kw_list = ["zoho crm", "zoho flow", "zoho", "make.com", "make.com", "airtable", "crm cleaning", "langchain", "zapier", "gpt", "gpt4", "gpt-4", "smartlead.ai", "apollo.io", "automation", "air.ai", "air ai", "marketing automation", "automated workflow", "integrate", "integration", "crm integration", "crm", "crm automation", "email automation", "Customer Relationship Management", "project workflows", "automate workflow", "api integration", "business process automation", "streamline", "data enrichment", "data cleaning", "data cleansing", "crm consultant", "AI Systems", "automation systems", "ai automation", "ai business", "business automation", "sales process", "sales automation", "automate sales", "digital marketing automation", "automation expert", "digital transformation", "llm", "large language model","generative ai", "spacy", "hugging face", "air table", "calendly", "integrations", "tech stack automation", "omnichannel automation", "notion", "lucidchart", "lucid chart", "airtable system", "data mining", "data scrubbing", "data extraction", "data pipeline", "chatgpt", "chat gpt", "zoho one", "zoho suite", "zohocrm", "zoho automation", "zoho forms", "zoho implementation", "integrate zoho", "zoho crm setup", "Lead Management Automation", "crm optimization", "data management", "google analytics", "ga4", "slack", "CRM reporting", "CRM workflow", "CRM api", "crm pipeline", "process optimization", "system integration", "task automation", "automated reporting", "operation automation tools", "integration specialist", "integraton expert", "workflow integration", "automation specialist", "google sheet", "no-code", "no code", "calendly integration", "zoho specialist", "zoho platform", "sales system", "sales onboarding", "lead tracking", "streamlining", "audience segmentation", "WhatsApp", "customer lifecycle", "procedure development", "Standard Operating Procedures",  "dashboard", "integrate systems", "automation flows", "crm implementation", "crm setup", "Email Deliverability", "uipath", "openai", "openai api", "chatgpt api", "OpenAI Embeddings", "Software Integration"]

    outbound_marketing = ["mass cold email", "cold emailing", "email campaign", "email marketing", "zoominfo", "linkedin sales navigator", "dripify"]
    ...
    base_kw_list = deduplicate_list(crm_automation_kw_list + outbound_marketing + ai_img_gen_list)

    skills_list = ["zoho crm", "automation", "make.com", "data integration", "api integration", "gpt", "chatgpt", "langchain", "airtable", "google analytics", "automated workflow", "Marketing Operations & Workflow", "sales operations", "crm automation", "campaign management", "email campaign setup", "Marketing Automation Strategy", "AI Classifier", "AI Implementation", "AI-Generated Text", "Apollo.io", "CRM Development", "CRM Software", "ChatGPT API Integration", "Lead Generation Analysis", "Google Sheets Automation", "Advertising Automation", "Automation Framework", "Build Automation", "ML Automation", "Robotic Process Automation", "task automation", "Growth Analytics", "Sales Analytics", "Sales Lead Lists", "Business Operations", "Insurance Agency Operations", "Operations Analytics", "Operations Management Software", "Application Integration Software", "Call Center Software", "Call Center Management", "Customer Experience Management Software", "Data Analytics", "Data Analytics &amp; Visualization Software", "Data Analytics Framework", "ERP Software", "Generative AI Software", "Low-Code Development", "Software Integration", "Sales Strategy", "Marketing Strategy", "Business Intelligence", "Customer Lifecycle Messaging", "Customer Service Analytics", "data mining", "procedure development", "Analytics", "zapier", "uipath", "data extraction", "openai api", "chatgpt api", "gpt-4", "openai inc.", "OpenAI Embeddings", "ai instruction"]
    ...
    all_searches = skills_searches + general_searches + no_quotes_general_searches  + title_searches + description_searches + details_searches

    #ignore searches
    ignore_searches = ["PHP", "video editor", "blockchain", "trading automation", ".net", "zoho books", "appointment setter", "sales development rep", "wordpress", "android", "ios", "animator", "full time", "full-time", "join our .{1,15} team", "exciting", "Wix", "Copywriter", "Pay Per Click Expert", "PPC Expert"]
